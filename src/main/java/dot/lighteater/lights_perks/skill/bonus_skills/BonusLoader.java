...
public class BonusLoader extends SimpleJsonResourceReloadListener {

    private static final Gson GSON = new Gson();

    private static final String DIRECTORY = "bonus_skills";

    private static final List<BonusSkillEntry> ENTRIES =
            new ArrayList<>();
    ...
    public static List<BonusSkillEntry> getEntries() {
